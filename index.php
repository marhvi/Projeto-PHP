    ...
    <div class="col-6 offset-3">
        <fieldset>
            ...
            <form action="loginSistema.php" method="post" class="form">
                ...
                <br><br><a href="recupera-email-livros.php" class="btn btn-dark">Recuperar senha</a>
                <div id="notify" class="form-text text-capitalize fs-4"><?= $notificacao ?></div>
                <div id="cadastro" class="form-text"><a href="cadastro.php">Ainda não tenho cadastro</a></div>
            </form>
        </fieldset>
    </div>
